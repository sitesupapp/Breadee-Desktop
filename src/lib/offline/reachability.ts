...
// the exact ambiguous state B1 must avoid before a submit. So before committing a
// cash sale we ASK the backend with a short, NON-MUTATING probe.
//
...
// begins. Once a submit has started, an ambiguous result stays with the Phase-A
// journal/reconcile path — this probe never reclassifies that into a new offline
// transaction.
