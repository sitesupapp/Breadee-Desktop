  ...
  return (
    <div className="mx-auto w-[320px] rounded-lg border border-paper-line bg-paper p-4 font-mono text-[12px] leading-tight text-paper-ink">
      ...
      {/* Customer Receivables / On Account. Rendered only when the server booked a
          ...
          gains the fields in a signed build.) Every figure is the server's, in the
          order's own USD/LBP selling currency, formatted with the shared
          `formatMoney` - nothing is recomputed here. */}
